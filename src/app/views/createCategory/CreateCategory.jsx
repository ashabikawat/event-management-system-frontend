...
const CreateCategory = () => {
  ...
  const saveCategory = async () => {
    ...
    formData.append("category_name", formValues.categoryName);
    formData.append("category_description", formValues.categoryDescription);

    formValues.categoryImages?.forEach((file) =>
  ...
  const handleSubmit = (e) => {
    ...
    if (!categoryDescription) {
      newError.categoryDescription = "Category description is required";
    }
              ...
              <Grid size={{ xs: 12, md: 6 }}>
                ...
                >
                  ...
                  >
                    ...
                    >
                      Category images <span style={{ color: "red" }}>*</span>
                    </label>
                    <Box
                      sx={{
